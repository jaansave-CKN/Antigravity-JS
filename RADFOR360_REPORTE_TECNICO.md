...
- **IA:** integración de Gemini real y multi-punto, con manejo de cuota/circuit-breaker parcial y **una ruta cliente-directa (BYOK) que expone la key del usuario en localStorage sin cifrar** — recomendable revisar antes de producción.
