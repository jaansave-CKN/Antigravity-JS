      ...
      <div className="min-h-screen bg-[#f7f9fb] flex items-center justify-center p-4">
        <div className="bg-white rounded-2xl shadow-sm border border-[#e2e8f0] w-full max-w-md overflow-hidden">
          ...
          <div className="px-8 py-7">
            ...
            <p className="text-center text-[10px] font-mono text-[#94a3b8]/70 mt-4">
              DEV: <span className="text-[#76777d]">jaansave@gmail.com</span> / <span className="text-[#76777d]">Radar360Admin!</span>
            </p>
          </div>
        </div>
      </div>
